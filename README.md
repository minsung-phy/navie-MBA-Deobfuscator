한양대학교 컴퓨터학부 프로그래밍 시스템 연구실에서 진행한 프로잭트 입니다.
  ...
  4. Python으로 만들었던 naive MBA Deobfuscator를 OCaml로 만들어보기
    ...
    5. x와 y가 아닌 임의의 변수가 들어와도 합성이 가능하게 하여야 한다. (e.g., t, s, a 등)
    (힌트 : Expr.ml의 5번째 줄의 Var of string을 확장하여 Batteries 라이브러리의 리스트와 fold 함수를 사용하면 될 것이다.)
    
    6. 숫자가 들어와도 합성이 가능하게 끔 하여야한다.
